...
```bash
git clone https://github.com/alexbalut/complexe-claude-robillard-gym-qr-guide.git
...
Credentials: `admin@complexe-claude-robillard.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Complexe sportif Claude-Robillard with 10 machines and sample issues/views.
