...
async function main() {
  console.log("Seeding Complexe sportif Claude-Robillard...");
  ...
  console.log("   Gym: Complexe sportif Claude-Robillard");
  console.log("   Login: admin@complexe-claude-robillard.demo / demo1234");
